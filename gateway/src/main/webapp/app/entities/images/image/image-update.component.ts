...
export class ImageUpdateComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.activatedRoute.data.subscribe(({ image }) => {
            this.image = image;
            this.created = this.image.created != null ? this.image.created.format(DATE_TIME_FORMAT) : null;
        });
    }
    ...
    save() {
        this.isSaving = true;
        this.image.created = this.created != null ? moment(this.created, DATE_TIME_FORMAT) : null;
